import { Chart as ChartJS, type ChartOptions, type ChartData, ArcElement, Legend, Tooltip, LinearScale, BarElement, Title, CategoryScale } from "chart.js";
...
const DashboardContent: React.FC = () => {
    ...
    const DoughnutData: ChartData<"doughnut"> = {
        labels: recentExpenses.map(v => v.category),
        datasets: [{
            label: "Depences (Ar)",
            data: recentExpenses.map(v => v.amount),
            borderWidth: 2,
            hoverOffset: 10,
    ...
    const BarData: ChartData<"bar"> = {
        ...
        datasets: [{
            label: "Evolution chaque mois",
            data: stats.map(v => parseInt(v.value.replace(/\D/, ""))),
            borderWidth: 2,
