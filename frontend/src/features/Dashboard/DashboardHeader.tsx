    ...
    return (
        <header className="flex items-center justify-between h-18 bg-[var(--color-bg-card)] border-b border-gray-200">
            ...
            <div className="flex items-center gap-4">
                ...
                <button className="flex text-[var(--color-text-sub)] items-center focus:outline-none cursor-pointer">
                    {/* cloche de notif */}
                ...
                <div className="relative">
                    <button className="relative flex items-center focus:outline-none cursor-pointer">
                        <img
